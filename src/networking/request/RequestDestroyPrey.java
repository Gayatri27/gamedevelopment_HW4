...
import networking.response.ResponseDestroyPrey;
import networking.response.ResponseReSpawnPrey;
...
public class RequestDestroyPrey extends GameRequest{
    ...
    public void parse() throws IOException{
     ...
     public void doBusiness() throws Exception{
        ...
        Play play = PlayManager.getInstance().getPlayByPlayerID(client.getPlayer().getID());
        ...
        player_id = PlayManager.manager.getPlayByPlayerID(client.getPlayer().getID())
